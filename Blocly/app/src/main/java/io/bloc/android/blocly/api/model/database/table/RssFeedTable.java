...
public class RssFeedTable extends Table {
    ...
    public static Cursor fetchFeedWithURL(SQLiteDatabase readOnlyDatabases, String feedURL) {
        return readOnlyDatabases.query(true, NAME, null, COLUMN_FEED_URL + " = ?",
                new String[]{feedURL}, null, null, null, null);
    }
